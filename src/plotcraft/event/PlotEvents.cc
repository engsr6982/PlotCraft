...
// 玩家评论地皮之前
PlayerCommentPlotBefore::PlayerCommentPlotBefore(Player* player, const PlotMetadata* pt) : mPlayer(player), mPlot(pt) {}
Player*             PlayerCommentPlotBefore::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerCommentPlotBefore::getPlot() const { return mPlot; }


// 玩家评论地皮之后
PlayerCommentPlotAfter::PlayerCommentPlotAfter(Player* player, const PlotMetadata* plot, string content)
: mPlayer(player),
  mPlot(plot),
  mContent(content) {}
Player*             PlayerCommentPlotAfter::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerCommentPlotAfter::getPlot() const { return mPlot; }
string              PlayerCommentPlotAfter::getContent() const { return mContent; }


// 玩家编辑评论之前
PlayerEditCommentBefore::PlayerEditCommentBefore(Player* player, const PlotMetadata* plot, CommentID comment)
: mPlayer(player),
  mPlot(plot),
  mCommentID(comment) {}
Player*             PlayerEditCommentBefore::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerEditCommentBefore::getPlot() const { return mPlot; }
...
const PlotMetadata* PlayerEditCommentAfter::getPlot() const { return mPlot; }
...
// 玩家删除评论
PlayerDeletePlotComment::PlayerDeletePlotComment(Player* player, const PlotMetadata* plot, CommentID comment)
: mPlayer(player),
  mPlot(plot),
  mCommentID(comment) {}
Player*             PlayerDeletePlotComment::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerDeletePlotComment::getPlot() const { return mPlot; }
CommentID           PlayerDeletePlotComment::getCommentID() const { return mCommentID; }


// 玩家购买地皮之前
PlayerBuyPlotBefore::PlayerBuyPlotBefore(Player* player, const PlotMetadata* plot, int price)
: mPlayer(player),
  mPlot(plot),
  mPrice(price) {}
Player*             PlayerBuyPlotBefore::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerBuyPlotBefore::getPlot() const { return mPlot; }
int                 PlayerBuyPlotBefore::getPrice() const { return mPrice; }


// 玩家购买地皮之后
PlayerBuyPlotAfter::PlayerBuyPlotAfter(Player* player, const PlotMetadata* plot, int price)
: mPlayer(player),
  mPlot(plot),
  mPrice(price) {}
Player*             PlayerBuyPlotAfter::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerBuyPlotAfter::getPlot() const { return mPlot; }
int                 PlayerBuyPlotAfter::getPrice() const { return mPrice; }


// 玩家修改地皮名称之前
PlayerChangePlotNameBefore::PlayerChangePlotNameBefore(Player* player, const PlotMetadata* plot)
: mPlayer(player),
  mPlot(plot) {}
Player*             PlayerChangePlotNameBefore::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerChangePlotNameBefore::getPlot() const { return mPlot; }


// 玩家修改地皮名称之后
PlayerChangePlotNameAfter::PlayerChangePlotNameAfter(Player* player, const PlotMetadata* plot, string newName)
: mPlayer(player),
  mPlot(plot),
  mNewName(newName) {}
Player*             PlayerChangePlotNameAfter::getPlayer() const { return mPlayer; }
const PlotMetadata* PlayerChangePlotNameAfter::getPlot() const { return mPlot; }
